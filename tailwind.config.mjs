...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'hero': ['clamp(2.5rem, 8vw, 5.25rem)', { lineHeight: '1.1', fontWeight: '700' }],
        'h1': ['clamp(2rem, 5vw, 3.5rem)', { lineHeight: '1.2', fontWeight: '600' }],
        'h2': ['clamp(1.75rem, 4vw, 2.5rem)', { lineHeight: '1.3', fontWeight: '600' }],
        'h3': ['clamp(1.5rem, 3vw, 2rem)', { lineHeight: '1.4', fontWeight: '500' }],
